...
def build_prompt(pdf_text: str) -> str:
    ...
    instructions = (
        ...
        "Pour identifiant_fournisseur, fournis le SIRET (14 chiffres), le SIREN (9 chiffres) ou à défaut le numéro de TVA intracommunautaire (ex: FR65377846381) de l'émetteur. "
...
def ask_fournisseur_details(pdf_text: str) -> Dict[str, str]:
    ...
    user_prompt = (
        ...
        "identifiant_fournisseur doit être un SIRET (14 chiffres), un SIREN (9 chiffres) ou à défaut le numéro de TVA intracommunautaire (ex: FR65377846381). Laisse vide si absent.\n"
